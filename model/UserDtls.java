...
public class UserDtls {
	...
	public UserDtls(Integer id, String name, String mobileNumber, String email, String address, String city,
			String state, String pincode, String password, String profileImage, String role, Boolean isEnabled,
	...
	public String toString() {
		return "UserDtls [id=" + id + ", name=" + name + ", mobileNumber=" + mobileNumber + ", email=" + email
				...
				+ ", password=" + password + ", profileImage=" + profileImage + ", role=" + role + ", isEnabled="
				+ isEnabled + ", accountNonLocked=" + accountNonLocked + ", failedAttempt=" + failedAttempt
